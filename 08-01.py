...
class HMMSoyoger(HMM):
        ...
        for line in self.data:
            ...
            for word in words:
                if word in seg_stop_words:
                    continue
                states.extend(HMM.get_tags(word))
            # 开始训练
    ...
    def lcut(self, sentence):
        try:
            ...
            return HMM.cut_sent(sentence, tags)
        except:
            return sentence


ss = HMMSoyoger()
ss.read_txt("data/syj_trainCorpus_utf8.txt")
ss.train()

print(ss.lcut("卧槽泥马勒戈壁的煞笔东西你像根草"))